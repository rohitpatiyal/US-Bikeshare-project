...
# 
# **Answer**:  The two questions related to bike sharing are: Q(1): In which days mostly the bikes are used. Q(2): What is the average time duration when the bike is free.
# 
...
def print_first_point(filename):
    ...
    with open(filename, 'r') as file_input:
        ...
        trip_rd =csv.DictReader(file_input)
        
        ## TODO: Use a function on the DictReader object to read the     ##
        ## first trip from the data file and store it in a variable.     ##
        ## see https://docs.python.org/3/library/csv.html#reader-objects ##
        first_trip = next(trip_rd)
...
def condense_data(in_file, out_file, city):
    ...
    with open(out_file, 'w') as f_o, open(in_file, 'r') as f_i:
        # set up csv DictWriter object - writer requires column names for the
        # first row as the "fieldnames" argument
        out_column = ['duration', 'month', 'hour', 'day_of_week', 'user_type']        
        trip_writer = csv.DictWriter(f_o, fieldnames = out_column)
        trip_writer.writeheader()
        
        ## TODO: set up csv DictReader object ##
        trip_reader = csv.DictReader(f_i)
        ...
        for row in trip_reader:
            ...
            dt_point['duration'] = duration_in_mins(row, city)
            dt_point['month'], dt_point['hour'], dt_point['day_of_week'] = time_of_trip(row, city)
            dt_point['user_type'] = type_of_user(row, city)
            ## TODO: write the processed information to the output file.     ##
            ## see https://docs.python.org/3/library/csv.html#writer-objects ##
            trip_writer.writerow(dt_point)
...
# 
# **Answer**:  The answers are given below: i) The city which has highest number of trips is NYC. ii)The city which has highest proportion of trips made by subscribers is NYC. iii)The city which has highest proportion of trips made by short-term customers is Chicago.
...
# 
# **Answer**: The average trip length for Washington: 18.The Proportion of long ridesis : 10.8 The average trip length for NYC: 15.The Proportion of long rides is : 7.3 The average trip length for Chicago: 16. The Proportion of long rides is : 8.3
...
# 
# **Answer**: The Washington city is selected, the avg trip duration of customer is 41.7. avg trip duration of subscribers is 12.5 therefore, customers takes much long rides in average in washington city.
